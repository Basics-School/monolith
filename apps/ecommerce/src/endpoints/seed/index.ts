...
export const seed = async ({
    ...
    payload.logger.info(`— Creating default tenant...`)

    // Create a default tenant for seeded content
    ...
    const [
        ...
        payload.create({
            collection: 'media',
            data: { ...imageHatData, tenant: defaultTenant.id },
            file: imageHatBuffer,
        }),
        payload.create({
            collection: 'media',
            data: { ...imageTshirtBlackData, tenant: defaultTenant.id },
            file: imageTshirtBlackBuffer,
        }),
        payload.create({
            collection: 'media',
            data: { ...imageTshirtWhiteData, tenant: defaultTenant.id },
            file: imageTshirtWhiteBuffer,
        }),
        payload.create({
            collection: 'media',
            data: { ...imageHero1Data, tenant: defaultTenant.id },
            file: heroBuffer,
        }),
